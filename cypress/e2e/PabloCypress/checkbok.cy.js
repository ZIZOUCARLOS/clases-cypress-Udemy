...
//cy.get('[data-testid="action:understood-button"]').check(); para los botones a elegir
//cy.get('[data-testid="action:understood-button"]').uncheck(); para deschequiar los botones.clear 
